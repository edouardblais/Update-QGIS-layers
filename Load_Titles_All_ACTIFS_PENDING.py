...
url_list = ['https://diffusion.mern.gouv.qc.ca/public/GESTIM/telechargements/Province_shape/TITRES_TITLES_ALL.zip',
            'https://diffusion.mern.gouv.qc.ca/public/GESTIM/telechargements/Province_shape/TITRES%20DEMANDE_TITLES%20PENDING_ALL.zip'
            ]
...
print("Active and Pending claims successfully loaded!")
